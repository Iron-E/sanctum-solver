...
mod tests
{
	...
	fn from_grid_coordinate()
	{
		...
		assert_eq!(Adjacent::from_grid_coordinate(&ARRAY, &Coordinate(2, 2), true), Adjacent {
		...
		// Nothing to the top.
		assert_eq!(Adjacent::from_grid_coordinate(&ARRAY, &Coordinate(2, 0), true), Adjacent {
			up: None,
			up_right: None,
		...
		assert_eq!(Adjacent::from_grid_coordinate(&ARRAY, &Coordinate(4, 3), true), Adjacent {
		...
		assert_eq!(Adjacent::from_grid_coordinate(&ARRAY, &Coordinate(3, 4), true), Adjacent {
		...
		// Nothing to the left.
		assert_eq!(Adjacent::from_grid_coordinate(&ARRAY, &Coordinate(0, 2), true), Adjacent {
